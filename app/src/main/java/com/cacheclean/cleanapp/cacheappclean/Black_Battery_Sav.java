...
public class Black_Battery_Sav extends Activity {
    ///Apply Extrem Power Saving Mode by allowing very few Apes to run
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(check % 2 == 0) {
                    ...
                    disable.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent i=new Intent(Black_Battery_Sav.this, NormalMod.class);
                            startActivity(i);
        ...
        alaram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent i=new Intent(Black_Battery_Sav.this, Apps_Pick.class);
                    startActivity(i);
                }
        ...
        switch (requestCode) {
            case 1:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "Allow Permission To Use Camera Aplicaton.", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
