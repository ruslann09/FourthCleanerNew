...
public class Apps_Pick extends Activity{
    SharedPreferences sharedpreferences;
    SharedPreferences.Editor editor;
    ImageView addcontact,addplaystore,addcalculator,addcamera,addclock,addmap;

    public final static String PREFERENCES_RES = "waseembest";

    /// Choose Aplicaton to Add it in Usable APP LIST
            ...
            addcontact.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!(sharedpreferences.getString("button1", "l").equals("4")
                        ...
                        text.setText("This Aplicaton Is Already Added");

                        Toast toast = new Toast(Apps_Pick.this);
                        toast.setGravity(Gravity.CENTER_VERTICAL, 0, 70);
                        toast.setDuration(Toast.LENGTH_LONG);
                        toast.setView(layout);
                        toast.show();

//                   Toast.makeText(Apps_Pick.this, "Choose Another Aplicaton This Aplicaton Is Already Added", Toast.LENGTH_SHORT).show();
                    }
