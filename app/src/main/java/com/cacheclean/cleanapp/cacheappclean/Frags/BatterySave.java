...
//            mWaveLoadingView.setBottomTitle(level+"%");
            ...
            if (level > 50 && level <= 65) {
                ...
                mWaveLoadingView.setCenterTitleColor(R.color.colorwhite);
        ...
        try {
            powersaving.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(getActivity(), PopUp_SavingPow.class);
            ...
            ultrasaving.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(getActivity(), UPop.class);
            ...
            normal.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(getActivity(), NormalMod.class);
                    startActivity(i);
                }
            });
